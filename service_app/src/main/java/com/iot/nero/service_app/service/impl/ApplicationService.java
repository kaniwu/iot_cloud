...
public class ApplicationService implements IApplicationService {
     ...
     * @return
     */
    public Result<Application> createApplication(Integer DId, String token, String name, String type, String tech, Integer trans, String company, Integer maxConnect, String desc) {
     ...
     * @return
     */
    public Result<List<ApplicationResult>> getApplications(Integer Uid, String token) {
        applicationFacade = null;
        developerFacade = null;
        dataFacade = null;
        ...
        try {
            ...
            try {
                ...
                return new Result<List<ApplicationResult>>(false, CONSTANT.DATA_FACADE_EXCEPTION);
            }
     ...
     * @return
     */
    public Result<Application> getApplication(Integer uid,Integer aid,String token, String pwd) {
        applicationFacade = null;
        developerFacade = null;
        try {
            try {
     ...
     * @return
     */
    public Result<ApplicationResult> getApplicationInfo(Integer uid, Integer aid, String token) {
        applicationFacade = null;
        developerFacade = null;
        clientFacade  = null;
     ...
     * @return
     */
    public Result<List<DataPoint>> getDataPoints(Integer uid,Integer aid, String token) {
        applicationFacade = null;
        developerFacade = null;
     ...
     * @return
     */
    public Result<DataPoint> addDataPoints(Integer uid,Integer aid, DataPointInfo data, String token) {
        applicationFacade = null;
        developerFacade = null;
     ...
     * @return
     */
    public Result<List<ClientConnResult>> getAppCurrentConn(Integer aid, Integer did, String token,Integer page,Integer num) {
        applicationFacade = null;
        developerFacade = null;
        clientFacade = null;
        dataFacade = null;
    ...
    public Result<DataPoint> deleteDataPoint(Integer uid, String token, Integer aid, Integer pid) {
        applicationFacade = null;
        developerFacade = null;
    ...
    public Result<List<MQMessage>> getMessage(Integer uid, String token, Integer aid, Integer page, Integer num) {
        applicationFacade = null;
        developerFacade = null;
        dataFacade = null;
        try {
