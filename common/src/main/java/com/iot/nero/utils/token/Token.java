...
public class Token implements Serializable {
    ...
    public String genCode() throws NoSuchAlgorithmException, UnsupportedEncodingException {
        ...
        switch (this.type){
            case MD5:
                return MD5.EncoderByMd5(key+MD5.EncoderByMd5(String.valueOf(date.getTime()))+ RandomString.getRandomString(64));
            case SHA:
                return SHA.EncoderBySha(key+SHA.EncoderBySha(String.valueOf(date.getTime()))+ RandomString.getRandomString(64));
            default:
                return MD5.EncoderByMd5(key+MD5.EncoderByMd5(String.valueOf(date.getTime()))+ RandomString.getRandomString(64));
        }
    }
